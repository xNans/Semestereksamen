...
<body>
    ...
    <div class="pagewhatwedo1 container">
        <div class="pagewhatwedo2 row">
            <div class="col-12 whatwedoheaderimage" style="background-image: url(<?php the_field("what_we_do_image") ?>)">
            <p class="pagewhatwedotext"><?php the_field("what_we_do_headline")?></p>
        </div>
        </div>
    </div>
